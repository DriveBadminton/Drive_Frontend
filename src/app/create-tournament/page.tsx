...
export default function CreateTournament() {
    ...
    const createTournament = () => {
        ...
        router.push("/court_manager"); // Redirect to dashboard after creation
    };
                    ...
                    <div className="flex items-center justify-center gap-4 text-sm sm:gap-8">
                        {[1, 2, 3].map((value) => (
                            <div key={value} className="flex items-center gap-3">
                                <div
                                    className={`flex h-10 w-10 items-center justify-center rounded-full text-base font-semibold ${step >= value ? "bg-gradient-to-r from-blue-600 to-cyan-500 text-white" : "bg-slate-200 text-slate-500"
                                        }`}
                                >
                                    {value}
                                </div>
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                <button
                                    ...
                                    className={`rounded-2xl border-2 p-6 transition-transform hover:-translate-y-0.5 ${!isPrivate ? "border-blue-500 bg-blue-50 text-blue-600" : "border-gray-200 bg-white"
                                        }`}
                                >
                        ...
                        <div>
                            ...
                            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                <button
                                    ...
                                    className={`rounded-2xl border-2 p-6 transition-transform hover:-translate-y-0.5 ${!skipParticipants ? "border-blue-500 bg-blue-50 text-blue-600" : "border-gray-200 bg-white"
                                        }`}
                                >
                                    <div className="text-center">
                                            ...
                                            {participants.map((participant) => (
                                                ...
                                                >
                                                    <div className="flex items-center gap-3">
                                                        <div
                                                            className={`flex h-10 w-10 items-center justify-center rounded-full text-sm font-semibold text-white ${participant.gender === "남자" ? "bg-blue-500" : "bg-pink-500"
                                                                }`}
                                                        >
