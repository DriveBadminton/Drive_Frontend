      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-500">
              <li>
                <a href="/player-search" className="transition-colors hover:text-gray-900">
                  선수 검색
                </a>
              </li>
              <li>
                <a href="/tournament-search" className="transition-colors hover:text-gray-900">
                  대회 검색
                </a>
              </li>
              <li>
                <a href="/court_manager" className="transition-colors hover:text-gray-900">
                  코트매니저
                </a>
              </li>
            </ul>
